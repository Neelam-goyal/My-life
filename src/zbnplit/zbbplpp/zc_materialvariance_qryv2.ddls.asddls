...
@EndUserText.label: 'Material Variance Report Analytical Query'
@ObjectModel.modelingPattern: #ANALYTICAL_QUERY
@ObjectModel.supportedCapabilities: [#ANALYTICAL_QUERY]
define transient view entity ZC_MaterialVariance_QRYV2
  ...
  with parameters
    ...
    p_date_to   : datum
  as projection on ZCUBE_MaterialVarianceV2(pCompany: $parameters.pCompany, pPrdnPlant: $parameters.pPrdnPlant, pFromDate:$parameters.p_date_from, pToDate:$parameters.p_date_to)
{
