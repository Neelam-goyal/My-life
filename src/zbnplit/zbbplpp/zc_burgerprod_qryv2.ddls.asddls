...
@EndUserText.label: 'ANALYTICAL QUERY BURGER PRODUCTION ORDER V2'
@ObjectModel.modelingPattern: #ANALYTICAL_QUERY
@ObjectModel.supportedCapabilities: [#ANALYTICAL_QUERY]
define transient view entity ZC_BURGERPROD_QRYV2
  ...
  with parameters
    ...
    p_date_to   : datum
  as projection on ZCUBE_BurgerProdOrderV2(pCompany: $parameters.pCompany, pPrdnPlant: $parameters.pPrdnPlant, p_date_from:$parameters.p_date_from, p_date_to:$parameters.p_date_to)
{
