...
@EndUserText.label: 'CUBE FOR BURGER PRODUCTION ORDER V2'
...
define view entity ZCUBE_BurgerProdOrderV2
  with parameters
    ...
    @Environment.systemField: #SYSTEM_DATE
    p_date_to   : sydate
  as select from ZFACT_BurgerProductionOrderV2(pCompany: $parameters.pCompany, pPrdnPlant: $parameters.pPrdnPlant, p_date_from: $parameters.p_date_from, p_date_to: $parameters.p_date_to) as item
