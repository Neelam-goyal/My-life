@EndUserText.label: 'Table Function Employee Statement'
@ClientHandling.type:  #CLIENT_DEPENDENT
@ClientHandling.algorithm: #SESSION_VARIABLE
@AccessControl.authorizationCheck: #NOT_REQUIRED
define table function ZTBLF_EMP_STATEMENT
  with parameters
    //    @Environment.systemField: #CLIENT
    //    pClient      : mandt,
    pCompanyCode : abap.char(4),
    pEmpCode     : abap.char(10),
...
returns
{
  ...
  SpecialGLTransactionType    : abap.char(1);
...
implemented by method
  zcl_emp_fiscal_stmt=>get_data_emp_statement;