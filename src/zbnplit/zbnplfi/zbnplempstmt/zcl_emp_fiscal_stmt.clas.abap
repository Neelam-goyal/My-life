...
CLASS zcl_emp_fiscal_stmt DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS get_data_emp_statement FOR TABLE FUNCTION ztblf_emp_statement.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS ZCL_EMP_FISCAL_STMT IMPLEMENTATION.


  METHOD get_data_emp_statement
         BY DATABASE FUNCTION FOR HDB
           LANGUAGE SQLSCRIPT
           OPTIONS READ-ONLY
           USING ZC_EmpStatement ZR_BillingDocumentRef ZR_PurchaseDocumentRef ZR_PaymentDocumentRef.
    RETURN
    ...
    from
        ZC_EmpStatement( :pCompanyCode , :pempcode, :pGLAccount, :pFromDate, :pToDate, :pBusinessPlace, :pIsRevDoc, :pIsExcSplGL) as item
        Left outer Join
             (
