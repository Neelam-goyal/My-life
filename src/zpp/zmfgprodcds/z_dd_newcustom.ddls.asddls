...
define view entity z_dd_newcustom as select distinct from I_MfgOrderConfirmation as a
...
//   and i2.GoodsMovementType = '531'
left outer join zcustomtableprod as j2 
  on c.Material = lpad(cast(j2.product as abap.char(18)), 18, '0') 
  and j2.type = 'ZWST' 
...
//    sum ( c.QuantityInEntryUnit )  as TotalQty_ZWST,
  
  c.BaseUnit as BaseUnit1
