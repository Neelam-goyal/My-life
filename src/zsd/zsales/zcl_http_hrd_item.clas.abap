...
*         READ TABLE it_final_zsales INTO DATA(wa_final_master) INDEX 1.
          ...
          it_final_zsales-created_at = cl_abap_context_info=>get_system_date(  ) && cl_abap_context_info=>get_system_time( ).
          ...
          wa_final_invdata-created_at = cl_abap_context_info=>get_system_date(  ) && cl_abap_context_info=>get_system_time( ) .
          ...
          wa_final_rpldata-created_at = cl_abap_context_info=>get_system_date(  ) && cl_abap_context_info=>get_system_time( ) .
