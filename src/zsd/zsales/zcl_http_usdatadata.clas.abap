...
*        DATA(it_final_rpldata) = lv_json-to_rpldata.
        ...
        IF it_final_USDATAMST  IS NOT INITIAL. "AND it_final_invdata IS NOT INITIAL.
          ...
          wa_final_USDATAMST-created_at  = cl_abap_context_info=>get_system_date(  ) && cl_abap_context_info=>get_system_time( ).
          ...
          LOOP AT it_final_USDATADATA INTO DATA(wa_final_USDATADATA).
            ...
            wa_final_USDATADATA-created_at = cl_abap_context_info=>get_system_date(  ) && cl_abap_context_info=>get_system_time( ).
