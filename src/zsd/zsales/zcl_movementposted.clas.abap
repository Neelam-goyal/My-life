...
*              ...
*            ENDLOOP.
          lv_cust_result = |{ sy-msgid }-{ sy-msgno }-{ sy-msgty }:{ sy-msgv1 } { sy-msgv2 }|.
           DATA(lv_msg) = commit_reported2-materialdocumentitem[ 1 ]-%msg->if_message~get_text( ).
...
*        COMMIT ENTITIES END.
      ...
      CLEAR : lv_cust_result ,ls_create_failed2, ls_create_reported2,commit_reported2,commit_failed2,ls_create_mapped2,commit_failed2,ls_create_reported2,ls_create_failed2.
