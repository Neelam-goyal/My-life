  ...
  as select from zcurrentstock
{
  ...
  opening_stock_value as OpeningStock,
  @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
  production_stock_value as ProductionStock,  
  @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit' 
  posted_stock_value as PostedStock,
  @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
  posted_return_stock_value as PostedReturnStock,
  @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
  ...
  @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
  adjustment_stock_value as AdjustmentStock,
  @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
  calculate_stock   as CalculateStock,  
  @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
  matlwrhsstkqtyinmatlbaseunit as MatlWrhsStkQtyInMatlBaseUnit,
  @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
  uposted_upto as UnpostedUpto,
  @Semantics.quantity.unitOfMeasure: 'MaterialBaseUnit'
  adjusted_mvt_stock as AdjustedMvtStock, 
